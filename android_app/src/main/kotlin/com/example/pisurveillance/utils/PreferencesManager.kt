...
class PreferencesManager(private val context: Context) {
    ...
    fun getCertificatePem(): String {
        // Note: This is a blocking call; use Flow variant in coroutines
        return ""  // Placeholder; implement async version if needed
    }
    ...
    fun getCertificateFingerprint(): String {
        return ""  // Placeholder; implement async version
    }
    ...
    fun isCertificatePinningEnabled(): Boolean {
        return false  // Placeholder; implement async version
    }
